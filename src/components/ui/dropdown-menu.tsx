  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      className={cn(
        ...
        inset && (dir === 'rtl' ? "pr-8" : "pl-8"),
        className
      )}
      {...props}
    >
      {children}
      <ChevronRight className={cn("h-4 w-4", dir === 'rtl' ? "mr-auto transform -scale-x-100" : "ml-auto")} />
    </DropdownMenuPrimitive.SubTrigger>
  )
})
...
const DropdownMenuShortcut = ({
  ...
  return (
    <span
      className={cn("text-xs tracking-widest opacity-60", dir === 'rtl' ? "mr-auto" : "ml-auto", className)}
      {...props}
    />
  )
}
